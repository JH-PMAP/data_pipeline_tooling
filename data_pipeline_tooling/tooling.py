...
def databricks_mount_container_blob(
    storage_account_name: str, container_name: str, secrets_scope: str, secrets_key: str
):
    """
    ...
    try:
        ...
        print(
            f"{container_name} container from {storage_account_name} storage account has been mounted with mountname {container_name}"
        )
